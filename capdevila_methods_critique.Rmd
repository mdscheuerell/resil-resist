...
```{r fit_model, message = FALSE, warning = FALSE, eval = FALSE}
## load libraries
library("MARSS")
...
## fit the model
mod_fit <- MARSS(matrix(yy, nrow = 1), model = mod_list, control = con_list)


## Capdevila estimates of r
rr <- diff(yy)
